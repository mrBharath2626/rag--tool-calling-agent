...
This project demonstrates how to build a manual tool-calling AI agent using LangChain. It is part of the RAG Bootcamp conducted by Nunnari Academy.
...
🧠 Key Concept
Tools are just Python functions. The LLM decides which tool to call, and your code executes it.
...
LangGraph
📂 Project Structure
day4_tool_calling.py # Main file with tools + agent loop README.md # Project documentation
